...
enum opt_code
{
  ...
  OPT_minline_thumb1_jumptable = 1012,       /* -minline-thumb1-jumptable */
  ...
  OPT_mthumb2_fake_apcs_frame = 1023,        /* -mthumb2-fake-apcs-frame */
  OPT_mtp_ = 1024,                           /* -mtp= */
  ...
  OPT_std_f95 = 1091,                        /* -std=f95 */
  OPT_std_gnu = 1092,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1093, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1094, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1095,                    /* -std=gnu++11 */

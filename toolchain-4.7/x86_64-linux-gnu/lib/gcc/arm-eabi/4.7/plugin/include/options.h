...
enum opt_code
{
  ...
  OPT_minline_thumb1_jumptable = 1009,       /* -minline-thumb1-jumptable */
  ...
  OPT_mthumb2_fake_apcs_frame = 1020,        /* -mthumb2-fake-apcs-frame */
  ...
  OPT_quiet = 1058,                          /* -quiet */
  OPT_r = 1059,                              /* -r */
  OPT_remap = 1060,                          /* -remap */
  OPT_s = 1061,                              /* -s */
  OPT_s_bc_abi = 1062,                       /* -s-bc-abi */
  OPT_save_temps = 1063,                     /* -save-temps */
  OPT_save_temps_ = 1064,                    /* -save-temps= */
  OPT_shared = 1065,                         /* -shared */
  OPT_shared_libgcc = 1066,                  /* -shared-libgcc */
  /* OPT_specs = 1067, */                    /* -specs */
  OPT_specs_ = 1068,                         /* -specs= */
  OPT_static = 1069,                         /* -static */
  OPT_static_libgcc = 1070,                  /* -static-libgcc */
  OPT_static_libgcj = 1071,                  /* -static-libgcj */
  OPT_static_libgfortran = 1072,             /* -static-libgfortran */
  OPT_static_libgo = 1073,                   /* -static-libgo */
  OPT_static_libstdc__ = 1074,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1075, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1076, */                /* -std=c++0x */
  OPT_std_c__11 = 1077,                      /* -std=c++11 */
  OPT_std_c__98 = 1078,                      /* -std=c++98 */
  OPT_std_c11 = 1079,                        /* -std=c11 */
  ...
  OPT_std_f2008ts = 1087,                    /* -std=f2008ts */
  OPT_std_f95 = 1088,                        /* -std=f95 */
  OPT_std_gnu = 1089,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1090, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1091, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1092,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1093,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1094,                      /* -std=gnu11 */
  ...
  /* OPT_std_iso9899_2011 = 1104, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1105,                     /* -std=legacy */
  OPT_symbolic = 1106,                       /* -symbolic */
  OPT_t = 1107,                              /* -t */
  OPT_time = 1108,                           /* -time */
  OPT_time_ = 1109,                          /* -time= */
  OPT_traditional = 1110,                    /* -traditional */
  OPT_traditional_cpp = 1111,                /* -traditional-cpp */
  OPT_trigraphs = 1112,                      /* -trigraphs */
  OPT_u = 1113,                              /* -u */
  OPT_undef = 1114,                          /* -undef */
  OPT_v = 1115,                              /* -v */
  OPT_version = 1116,                        /* -version */
  OPT_w = 1117,                              /* -w */
  OPT_wrapper = 1118,                        /* -wrapper */
  OPT_x = 1119,                              /* -x */
  OPT_z = 1120,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
